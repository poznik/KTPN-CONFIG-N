...
public static class CustomerProfileApplier
{
    public static bool Apply(ProjectConfig config, CustomerProfileSpec? profile)
    {
        ...
        SetString(() => config.ServicePlatformColor, v => config.ServicePlatformColor = v, settings.ServicePlatformColor);
        ...
        SetBool(() => config.HasServicePlatform, v => config.HasServicePlatform = v, settings.HasServicePlatform);
